...
public class AlgaeKnockerAuto extends Command {
    ...
    public static Command create() {
        return new SequentialCommandGroup(
            ...
            GetToFieldPositionCommand.create(Field.DISTANCE_OF_REEF_TO_STARTING_LINE, 0.0, new Rotation2d(Units.degreesToRadians(180))), // ideally should be facing the reef and at the edge of the reef
