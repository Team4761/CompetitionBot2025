 ...
 */
public class TelemetryNumberEntry implements TelemetryEntry {
     ...
     */
    private DoubleSupplier functionToCallOnUpdate;
     ...
     */
    public TelemetryNumberEntry(DoubleSupplier functionToCallOnUpdate, NetworkTableEntry entry) {
     ...
     */
    public void update() {
        double newValue = functionToCallOnUpdate.getAsDouble();
