...
public class LEDSubsystem extends SubsystemBase {
    ...
    */
    ...
    public void periodic() {
        ...
        // LEDPattern pattern = LEDPattern.gradient(GradientType.kContinuous, new StupidColor(125, 0, 0), new StupidColor(245,155,66), new StupidColor(Color.kBlanchedAlmond));
    }


    /**
     * This will apply the given pattern to the LEDs.
     * This will also save the last used pattern as leds.getPreviousPattern()
