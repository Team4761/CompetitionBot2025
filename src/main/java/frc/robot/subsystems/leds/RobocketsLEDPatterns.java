...
public class RobocketsLEDPatterns {
    ...
    public static final LEDPattern BLAKE_GRADIENT = LEDPattern.gradient(GradientType.kContinuous, new StupidColor(255,0,0), new StupidColor(255,255,255), new StupidColor(255,0,0), new StupicColor(0,0,0));
}
